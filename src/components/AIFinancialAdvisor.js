...
function AIFinancialAdvisor({ income, expenses }) {
  ...
  const analyzeFinances = async () => {
    ...
    try {
      ...
      setAnalysis(
        "Sorry, I encountered an error while analyzing your finances. Please try again later."
      );
    }
  ...
  return (
    <div
      className="card card-custom gradient-card border-success"
      data-name="ai-financial-advisor"
      data-file="src/components/AIFinancialAdvisor.js"
    >
      <div className="card-body">
        ...
        <div className="mb-4">
          <p className="text-muted mb-4">
            ...
            Our AI will analyze your financial situation and suggest ways to
          ...
          <button
            ...
            className={`btn btn-primary btn-custom w-100 btn-icon ${
        ...
        {!hasAnalyzed && !isAnalyzing && (
          <div className="mt-4 p-3 bg-info bg-opacity-10 rounded">
            <p className="text-info mb-0 small">
              ...
              Make sure to add your income and expenses in the Budget Tracker
              above, then click the button to get your personalized analysis.
            </p>
          </div>
        )}
      </div>
